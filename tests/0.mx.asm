...
;----------------------------------]
;[----------------------------------
_text__getHash_inexplicit_return_void:
              mov     r11            , qword [rsp+8]  ; load->v1
              mov     rbp            , r11            
              mov     r11            , qword [rsp+16] ; load->v2
              mov     rbx            , r11            
...
_text__put_if0_init:
              ...
              and     r10            , 15             
              mov     qword [rsp+152], r10            ; save->v19
_text__put_if0_check:
              mov     r10            , qword [rsp+152]; load->v19
              cmp     r10b           , 0              
              mov     qword [rsp+152], r10            ; save->v19
              je      _text__put_if0_else                 
;----------------------------------]
;[----------------------------------
_text__put_if0_start:
              ...
              mov     qword [r10]    , r11            ; assign->table[p]
              ...
              mov     r11            , qword [rsp]    ; load->v0
              mov     qword [r10]    , r11            ; assign->table[p].key
              ...
              mov     r11            , qword [rsp+8]  ; load->v1
              mov     qword [r10]    , r11            ; assign->table[p].data
              mov     r10            , qword [rsp+72] ; load->v9
              mov     r10            , 0              
              mov     qword [rsp+72] , r10            ; save->v9
              ...
              mov     r11            , qword [rsp+296]; translate->qword [v37]
              mov     r10            , qword [r11]    
              ...
              mov     r11            , qword [rsp+72] ; load->v9
              mov     qword [r10]    , r11            ; assign->table[p].next
_text__put_ret0:
              mov     r11            , qword [rsp+16] ; load->v2
              mov     rbp            , r11            
              mov     r11            , qword [rsp+24] ; load->v3
...
_text__put_if0_end:
              ...
              mov     r10            , r11            ; assign->ptr
              mov     qword [rsp+352], r10            ; save->v44
_text__put_for0_init:
              ...
              and     r10            , 15             
              mov     qword [rsp+376], r10            ; save->v47
_text__put_for0_init_check:
              mov     r10            , qword [rsp+376]; load->v47
              cmp     r10b           , 0              
              mov     qword [rsp+376], r10            ; save->v47
              je      _text__put_for0_end                 
;----------------------------------]
;[----------------------------------
_text__put_for0_start:
_text__put_if1_init:
              ...
              and     r10            , 15             
              mov     qword [rsp+400], r10            ; save->v50
_text__put_if1_check:
              mov     r10            , qword [rsp+400]; load->v50
              cmp     r10b           , 0              
              mov     qword [rsp+400], r10            ; save->v50
              je      _text__put_if1_else                 
;----------------------------------]
;[----------------------------------
_text__put_if1_start:
              ...
              mov     r11            , qword [rsp+432]; translate->qword [v54]
              mov     r10            , qword [r11]    
              mov     qword [rsp+440], r10            ; save->v55
              mov     r10            , qword [rsp+432]; translate->qword [v54]
              mov     r11            , qword [rsp+424]; load->v53
              mov     qword [r10]    , r11            ; assign->ptr.next
              ...
              mov     r11            , qword [rsp+448]; translate->qword [v56]
              mov     r10            , qword [r11]    
              ...
              mov     r10            , qword [rsp+464]; translate->qword [v58]
              mov     r11            , qword [rsp]    ; load->v0
              mov     qword [r10]    , r11            ; assign->ptr.next.key
              mov     r10            , qword [rsp+72] ; load->v9
              mov     r10            , 0              
              mov     qword [rsp+72] , r10            ; save->v9
              ...
              mov     r11            , qword [rsp+72] ; load->v9
              mov     qword [r10]    , r11            ; assign->ptr.next.next
              jmp     _text__put_if1_end                 
;----------------------------------]
;[----------------------------------
_text__put_if1_else:
_text__put_if1_end:
...
_text__put_for0_continue:
              ...
              mov     r11            , qword [rsp+528]; translate->qword [v66]
              mov     r10            , qword [r11]    
...
_text__put_for0_end:
              ...
              mov     r10            , qword [rsp+552]; translate->qword [v69]
              mov     r11            , qword [rsp+8]  ; load->v1
              mov     qword [r10]    , r11            ; assign->ptr.data
_text__put_inexplicit_return_void:
              mov     r11            , qword [rsp+16] ; load->v2
              mov     rbp            , r11            
              mov     r11            , qword [rsp+24] ; load->v3
              mov     rbx            , r11            
...
_text__get_for0_init:
              ...
              and     r10            , 15             
              mov     qword [rsp+152], r10            ; save->v19
_text__get_for0_init_check:
              mov     r10            , qword [rsp+152]; load->v19
              cmp     r10b           , 0              
              mov     qword [rsp+152], r10            ; save->v19
              je      _text__get_for0_end                 
;----------------------------------]
;[----------------------------------
_text__get_for0_start:
              mov     r10            , qword [rsp+160]; load->v20
              mov     r11            , qword [rsp+128]; load->v16
              mov     r10            , r11            
              mov     qword [rsp+160], r10            ; save->v20
...
;----------------------------------]
;[----------------------------------
_text__get_inexplicit_return_void:
              mov     r11            , qword [rsp+8]  ; load->v1
              mov     rbp            , r11            
              mov     r11            , qword [rsp+16] ; load->v2
              mov     rbx            , r11            
...
_text__main_for0_start:
              ...
              mov     r10            , qword [r11]    
              mov     qword [rsp+152], r10            ; save->v19
              mov     r10            , qword [rsp+144]; translate->qword [v18]
              mov     r11            , qword [rsp+104]; load->v13
              mov     qword [r10]    , r11            ; assign->table[i]
